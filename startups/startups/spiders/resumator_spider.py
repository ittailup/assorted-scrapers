...
class ResumatorSpider(Spider):
    ...
    start_urls = ['http://xsilva.theresumator.com/apply/jobs/', 
                'http://quickmobile.theresumator.com/apply/jobs/',
                'http://wattpad.theresumator.com/apply/', 
                'http://eventmobi.theresumator.com/apply', 'http://500px.theresumator.com/apply']
